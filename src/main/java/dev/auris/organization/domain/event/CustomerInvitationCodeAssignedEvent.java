...
public record CustomerInvitationCodeAssignedEvent(
        OrganizationId organizationId,
        InvitationCode invitationCode,
        OffsetDateTime occurredOn
) implements DomainEvent {
    public CustomerInvitationCodeAssignedEvent(OrganizationId organizationId, InvitationCode invitationCode) {
    ...
    public InvitationCodeType type() {
        return InvitationCodeType.CUSTOMER;
    }
}
